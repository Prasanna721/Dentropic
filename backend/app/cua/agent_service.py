...
2. Navigate to the Open Dental trial download page
3. Find and click the download link for TrialDownload-25-3-48.exe
    ...
    async def run_task(self) -> AsyncGenerator[WebSocketMessage, None]:
        ...
        try:
            ...
            yield WebSocketMessage(
                ...
                payload=StatusPayload(
                    status="running",
                    message="Agent started, launching Open Dental...",
                ).model_dump(),
            )

            # Define the task
            task_instruction = """
Navigate to https://opendental.com/site/trial.html and click the download link
for the Open Dental trial software.

Steps:
1. Open the web browser
2. Navigate to the URL: https://opendental.com/site/trial.html
3. Wait for the page to load completely
4. Find and click the "TrialDownload-25-3-48.exe" download link on the page
